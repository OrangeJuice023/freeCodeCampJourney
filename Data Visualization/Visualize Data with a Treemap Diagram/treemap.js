...
const selectedDataset = urlParams.get('data') || DEFAULT_DATASET;
let currentDataset = selectedDataset;

document.getElementById('title').innerHTML = DATASETS[currentDataset].TITLE;
document.getElementById('description').innerHTML = DATASETS[currentDataset].DESCRIPTION;

// Function to change dataset and update the visualization
...
function drawTreeMap() {
  d3.json(DATASETS[currentDataset].FILE_PATH)
    .then((data) => {
      var root = d3
        .hierarchy(data)
